...
class PerformanceList<T> extends StatelessWidget {
  final List<T> items;
...
class SliverPerformanceList<T> extends StatefulWidget {
  final List<T> items;
  final Widget Function(BuildContext context, T item) itemBuilder;
  final Future<void> Function()? onEndReached;
  final bool isLoading;
  ...
  @override
  State<SliverPerformanceList<T>> createState() =>
      _SliverPerformanceListState<T>();
}

class _SliverPerformanceListState<T> extends State<SliverPerformanceList<T>> {
  @override
  void initState() {
    super.initState();
  }
